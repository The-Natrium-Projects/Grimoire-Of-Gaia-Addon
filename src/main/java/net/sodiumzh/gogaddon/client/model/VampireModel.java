...
public class VampireModel extends EntityModel<VampireEntity> implements HeadedModel, ArmedModel {
	...
	public VampireModel(float scaleFactor) {
		textureWidth = 128;
		textureHeight = 64;
		...
		leftshoulder.addBox(-0.5F, -1F, -1.5F, 3, 4, 3, scaleFactor);
