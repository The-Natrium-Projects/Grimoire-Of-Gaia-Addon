package net.sodiumzh.gogaddon.entity.ai;
...
import net.sodiumzh.gogaddon.entity.behavior.IRangedAttackBehaviors;
...
public class GOGAddonRangedAttackGoal extends Goal {
    ...
    public void tick() {
        ...
        if (--this.attackTime == 0) {
            ...
            this.rangedAttackBehaviors.performRangedAttack(this.target, f1);
