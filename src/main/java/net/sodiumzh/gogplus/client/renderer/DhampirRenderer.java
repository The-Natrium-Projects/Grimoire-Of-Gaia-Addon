...
public class DhampirRenderer extends MobRenderer<DhampirEntity, DhampirModel> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION =
        new ModelLayerLocation(new ResourceLocation(GOGPlus.MOD_ID, "dhampir"), "main");

    private static final ResourceLocation EYES_TEXTURE =
        new ResourceLocation(GOGPlus.MOD_ID, "textures/entity/dhampir/dhampir_eyes.png");
    private static final ResourceLocation TEXTURE =
        new ResourceLocation(GOGPlus.MOD_ID, "textures/entity/dhampir/dhampir.png");
