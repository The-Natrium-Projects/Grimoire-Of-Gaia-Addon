...
public class FutakuchiOnnaRenderer extends MobRenderer<FutakuchiOnnaEntity, FutakuchiOnnaModel> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION =
        new ModelLayerLocation(new ResourceLocation(GOGPlus.MOD_ID, "futakuchi_onna"), "main");
    private static final ResourceLocation TEXTURE =
        new ResourceLocation(GOGPlus.MOD_ID, "textures/entity/futakuchi_onna/futakuchi_onna.png");
